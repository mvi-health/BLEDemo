...
import com.example.bledemo.bluetooth.REQUEST_ENABLE_BT
import com.example.bledemo.databinding.FragmentEnableBluetoothBinding
...
class EnableBluetoothFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        BLEServer.requestEnableBluetooth.observe(this, bluetoothEnableObserver)
    }
        ...
        when (requestCode) {
            REQUEST_ENABLE_BT -> {
                if (resultCode == Activity.RESULT_OK) {
                    BLEServer.startServer(requireActivity().application)
                }
                super.onActivityResult(requestCode, resultCode, data)
            }
